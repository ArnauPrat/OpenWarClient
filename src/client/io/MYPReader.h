...
namespace owc  {
	...
	class MYPArchiveLoader : public io::IArchiveLoader
	{
	public:

		//! Constructor
		MYPArchiveLoader(io::IFileSystem* fs);
	...
	//! reads from myp 
	class MYPReader : public virtual io::IFileArchive, virtual io::CFileList
	{
	public:

		MYPReader( io::IReadFile* file, bool ignoreCase, bool ignorePaths);
		virtual ~MYPReader();
