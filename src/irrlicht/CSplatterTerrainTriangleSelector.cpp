...
//! constructor
CSplatterTerrainTriangleSelector::CSplatterTerrainTriangleSelector ( ISplatterTerrainSceneNode* node, s32 LOD )
	: SceneNode(node)
{
	#ifdef _DEBUG
...
//! destructor
CSplatterTerrainTriangleSelector::~CSplatterTerrainTriangleSelector()
{
...
//! Gets all triangles.
void CSplatterTerrainTriangleSelector::getTriangles(core::triangle3df* triangles,
...
s32 CSplatterTerrainTriangleSelector::getTriangleCount() const
{
	return TrianglePatches.TotalTriangles;
}


ISceneNode* CSplatterTerrainTriangleSelector::getSceneNodeForTriangle(
...
*/
u32 CSplatterTerrainTriangleSelector::getSelectorCount() const
{
	return 1;
}
...
*/
ITriangleSelector* CSplatterTerrainTriangleSelector::getSelector(u32 index)
{
	if (index)
		return 0;
	else
...
Only useful for MetaTriangleSelector others return 'this' or 0
*/
const ITriangleSelector* CSplatterTerrainTriangleSelector::getSelector(u32 index) const
{
	if (index)
		return 0;
	else
