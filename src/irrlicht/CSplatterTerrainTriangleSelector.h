...
to him.
*/
class CSplatterTerrainTriangleSelector : public ITriangleSelector
{
public:

	//! Constructs a selector based on an ISplatterTerrainSceneNode
	CSplatterTerrainTriangleSelector(ISplatterTerrainSceneNode* node, s32 LOD);
...
private:
	...
	ISplatterTerrainSceneNode* SceneNode;
